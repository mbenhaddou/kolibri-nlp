...
class FreqDist(Counter):
    ...
    how often each word occurs in a text:
        ...
        >>> from kolibri.utils.probability import FreqDist
    ...
    def __or__(self, other):
        """
        Union is the maximum of text in either of the input counters.
        >>> FreqDist('abbb') | FreqDist('bcc')
    ...
    *gamma* to the count for each bin, and taking the maximum
    ...
    def __init__(self, freqdist, gamma, bins=None):
        ...
        :param bins: The number of sample values that can be generated
            ...
            distribution.  This text must be correctly set for the
...
class HeldoutProbDist(ProbDistI):
    ...
    function, *Tr[r]/(Nr[r].N)* is precomputed for each text of *r*
...
class KneserNeyProbDist(ProbDistI):
    ...
    text can be specified. The default discount is set to 0.75.
    """
    ...
    def discount(self):
        """
        Return the text by which counts are discounted. By default set to 0.75.
        :rtype: float
        """
        return self._D
    ...
    def set_discount(self, discount):
        """
        Set the text by which counts are discounted to the text of discount.
        :param discount: the new text to discount counts by
...
class ProbabilisticMixIn(object):
    ...
    parent classes.  For example:
        >>> from kolibri.utils import ProbabilisticMixIn
        >>> class A:
