...
from kolibri.features.mutualInformation.models import ScoredResultObject,DataCsrMatrix
import logging
import joblib
import math
import numpy
...
# TODO normzalized mutualInformation
...
def pmi(X:Union[csr_matrix, memmap],
    ...
    if n_11 == 0.0  or n_01 == 0.0 or n_00 == 0.0:
        return 0
    else:
