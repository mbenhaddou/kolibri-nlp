import re
from kolibri.tokenizer import Tokenizer
...
# URL patterns due to John Gruber, modified by Tom Winzig. See
...
def _replace_html_entities(text, keep=(), remove_illegal=True, encoding='utf-8'):
    ...
    See https://github.com/scrapy/w3lib/blob/master/w3lib/html2text2.py
...
class TweetTokenizer(Tokenizer, Component):
    r"""
