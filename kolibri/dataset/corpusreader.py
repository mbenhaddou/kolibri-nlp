...
from .utils import find_corpus_fileids, concat, StreamBackedCorpusView, PathPointer, ZipFilePathPointer, FileSystemPathPointer

class CorpusReader(object):
    """
    A base class for "dataset reader" classes, each of which can be
    used to read a specific dataset format.  Each individual dataset
    reader instance is used to read a specific dataset, consisting of
    ...
    A separate subclass is defined for each dataset format.  These
    subclasses define one or more methods that provide 'views' on the
    dataset contents, such as ``words()`` (for a list of words) and
    ``parsed_sents()`` (for a list of parsed sentences).  Called with
    no arguments, these methods will return the contents of the entire
    dataset.  For most corpora, these methods define one or more
    selection arguments, such as ``fileids`` or ``categories``, which can
    be used to select which portion of the dataset should be returned.
    """
    ...
    def __init__(self, root, fileids, encoding='utf8', tagset=None):
        ...
        :param root: A path pointer identifying the root directory for
            this dataset.  If a string is specified, then it will be
            converted to a ``PathPointer`` automatically.
        :param fileids: A list of the files that make up this dataset.
            This list can either be specified explicitly, as a list of
            strings; or implicitly, as a regular expression over file
            paths.  The absolute path for each file will be constructed
            by joining the reader's root to each file name.
        :param encoding: The default unicode encoding for the files
            that make up the dataset.  The text of ``encoding`` can be any
            of the following:
            ...
            - A list: ``encoding`` should be a list of ``(regexp, encoding)``
              ...
              will be the ``encoding`` text for the first tuple whose
        ...
        :param tagset: The name of the tagset used by this dataset, to be used
        ...
        if not type(fileids) is list and os.path.isabs(fileids):
            fileids=[fileids]
        ...
        self._root = root
        """The root directory for this dataset."""
        ...
        """The default unicode encoding for the fileids that make up
           this dataset.  If ``encoding`` is None, then the file
    ...
    def ensure_loaded(self):
        """
        Load this dataset (if it has not already been loaded).  This is
        used by LazyCorpusLoader as a simple method that can be used to
        make sure a dataset is loaded -- e.g., in case a user wants to
        do help(some_corpus).
        """
    ...
    def readme(self):
        """
        Return the contents of the dataset README file, if it exists.
        """
        return self.open("README").read()

    def license(self):
        """
        Return the contents of the dataset LICENSE file, if it exists.
        """
        return self.open("LICENSE").read()

    def citation(self):
        """
        Return the contents of the dataset citation.bib file, if it exists.
        """
    ...
    def abspaths(self, fileids=None, include_encoding=False, include_fileid=False):
        """
        Return a list of the absolute paths for all fileids in this dataset;
        ...
        :param fileids: Specifies the set of fileids for which paths should
            ...
            text is always a list of paths, even if ``fileids`` is a
    ...
    def encoding(self, file):
        """
        Return the unicode encoding for the given dataset file, if known.
    ...
    root = property(
        _get_root,
        doc="""
        The directory where this dataset is stored.
        :type: PathPointer""",
    )
...
class CategorizedCorpusReader(object):
    """
    A mixin class used to aid in the implementation of dataset readers
    for categorized corpora.  This class defines the method
    ``categories()``, which returns a list of the categories for the
    dataset or for a specified set of fileids; and overrides ``fileids()``
    ...
    def __init__(self, kwargs):
        ...
        follows:
          - cat_pattern: A regular expression patterns used to find the
            category for each file identifier.  The patterns will be
    ...
    def categories(self, fileids=None):
        """
        Return a list of the categories that are defined for this dataset,
    ...
    def fileids(self, categories=None):
        ...
        this dataset, or that make up the given category(s) if specified.
        """
...
class SyntaxCorpusReader(CorpusReader):
    ...
    syntactically parsed text.  Subclasses should define:
      - ``__init__``, which specifies the location of the dataset
        and a method for detecting the sentence blocks in dataset files.
