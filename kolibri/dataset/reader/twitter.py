...
from kolibri.tokenizer import TweetTokenizer

from ...dataset.utils import StreamBackedCorpusView, concat, ZipFilePathPointer
from ...dataset.corpusreader import CorpusReader
...
class TwitterCorpusReader(CorpusReader):
    ...
    text of the environmental variable `TWITTER`, and then invoke the reader
    as follows::
    ...
    """
    The dataset view class used by this reader.
    """
    ...
    def __init__(
        ...
        """Check that all user-created dataset files are non-empty."""
